...
heroImage: '../../assets/physio-joelho-corrida-hero.jpg'
heroImageAlt: 'Corredor treinando ao ar livre'
tags: ['fisioterapia esportiva', 'corrida', 'joelho']
---
...
![Fisioterapeuta avaliando a marcha e o alinhamento do joelho de um corredor](../../assets/physio-joelho-corrida-inline.jpg)
...
## Exercícios que costumam compor o tratamento

Embora o programa deva ser individualizado, alguns exercícios aparecem com frequência no tratamento da dor patelofemoral:

- **Agachamento parcial com apoio**, trabalhando o quadríceps dentro de uma amplitude que não sobrecarrega a articulação em excesso.
- **Elevação pélvica (ponte) unilateral**, direcionada ao glúteo máximo e à estabilidade do quadril durante o apoio de um único membro.
- **Step-up (subida em caixote) controlado**, que reproduz parte da demanda da corrida em um movimento mais lento e monitorado.
- **Exercícios de estabilidade de quadril em pé**, como o "monster walk" com elástico, focados no glúteo médio.

## Erros comuns durante a recuperação

- **Parar de correr por completo sem necessidade.** Na maioria dos casos leves a moderados, reduzir volume e ajustar a técnica é suficiente, sem exigir afastamento total da corrida.
- **Voltar ao volume anterior assim que a dor passa.** A progressão precisa continuar gradual mesmo depois da melhora, já que os tecidos ainda estão se adaptando à carga.
- **Ignorar a musculatura do quadril.** Focar só no joelho, sem fortalecer quadril e glúteos, tende a deixar o problema recorrente.

## Perguntas frequentes

**Corrida em descida piora a dor patelofemoral?** Sim, geralmente. A descida aumenta a força de compressão entre a patela e o fêmur, por isso costuma ser uma das primeiras situações a incomodar.

**Preciso trocar de tênis para tratar a dor patelofemoral?** Nem sempre é o fator principal, mas um calçado inadequado pode contribuir. A avaliação da pisada ajuda a definir se essa é realmente uma variável relevante no seu caso.

**Quanto tempo leva para voltar a correr sem dor?** Casos leves costumam melhorar em 4 a 6 semanas de fortalecimento e ajuste de carga. Quadros mais avançados, com dor de longa data, podem levar de 2 a 3 meses até um retorno pleno e confortável ao volume de treino anterior.

**Musculação ajuda a prevenir a dor patelofemoral?** Sim, especialmente o fortalecimento de quadríceps, glúteos e musculatura do quadril, que são exatamente os grupos musculares mais associados à origem desse quadro em corredores.
