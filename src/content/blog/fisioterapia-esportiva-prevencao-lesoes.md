...
heroImageAlt: 'Fisioterapeuta esportiva atendendo atleta lesionado à beira do campo'
tags: ['fisioterapia esportiva', 'prevenção de lesões', 'reabilitação']
---
...
1. **Controle da dor e inflamação** — nos primeiros dias, o foco é proteger o tecido lesionado sem gerar imobilidade excessiva.
2. **Recuperação de amplitude de movimento** — restabelecer a mobilidade da articulação afetada de forma gradual.
3. **Fortalecimento progressivo** — reintrodução de carga de forma controlada, respeitando a capacidade de cicatrização do tecido.
4. **Trabalho funcional e específico do esporte** — exercícios que reproduzem os gestos da modalidade praticada.

Pular etapas nessa progressão é uma das principais causas de recidiva de lesão.

![Fisioterapeuta auxiliando atleta em exercício de mobilidade de ombro durante reabilitação](../../assets/physio-esportiva-inline.jpg)
