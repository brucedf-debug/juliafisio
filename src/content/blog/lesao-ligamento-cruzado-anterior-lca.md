...
heroImage: '../../assets/physio-lca-hero.jpg'
heroImageAlt: 'Atleta sendo avaliado por fisioterapeuta após lesão no joelho durante treino'
tags: ['fisioterapia esportiva', 'joelho', 'LCA']
---
...
![Fisioterapeuta conduzindo exercício de reabilitação de joelho em atleta](../../assets/physio-lca-inline.jpg)
...
## Por que o joelho oposto também precisa de atenção

Um detalhe que costuma surpreender atletas em reabilitação de LCA é a importância de trabalhar também o joelho saudável. Estudos mostram que o risco de lesão no membro oposto após uma reconstrução de LCA é significativamente maior do que na população geral, provavelmente por uma combinação de fatores biomecânicos que já existiam antes da primeira lesão e que também expõem o outro joelho ao mesmo risco. Por isso, um programa de reabilitação bem estruturado costuma incluir avaliação e fortalecimento bilateral, não apenas do lado operado, como estratégia de prevenção de uma segunda lesão.

## O componente psicológico do retorno ao esporte

Recuperar força e amplitude de movimento é apenas parte do processo — a confiança psicológica para voltar a se movimentar com intensidade máxima, sem hesitação no momento de um corte ou uma aterrissagem, é outro fator que influencia diretamente o sucesso do retorno ao esporte. Muitos atletas fisicamente prontos ainda apresentam um padrão de movimento hesitante ou assimétrico por medo inconsciente de uma nova lesão, o que por si só aumenta o risco de recidiva. Por isso, alguns programas de reabilitação incluem avaliações específicas de prontidão psicológica antes da liberação final para o esporte.

## Perguntas frequentes

**Quanto tempo leva a reabilitação completa do LCA?** Costuma variar entre 6 e 12 meses, dependendo da modalidade esportiva, da resposta individual e dos critérios de retorno estabelecidos pela equipe.

**É possível jogar futebol de novo depois de uma lesão de LCA?** Sim, a grande maioria dos atletas que segue uma reabilitação completa e bem orientada retorna à modalidade praticada anteriormente, embora o processo exija paciência e constância.

**Enxerto de tendão próprio ou de doador: existe diferença na reabilitação?** Sim, o tipo de enxerto usado na cirurgia pode influenciar o ritmo inicial da reabilitação, já que a área doadora, quando usa tecido do próprio paciente, também precisa de tempo para cicatrizar e recuperar força.

**A lesão de LCA sempre exige cirurgia em atletas?** Não necessariamente. Alguns atletas, mesmo em esportes de alto nível, conseguem retornar à prática com um programa conservador bem estruturado, embora a decisão dependa de uma avaliação criteriosa da estabilidade do joelho.
