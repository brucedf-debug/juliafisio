---
title: 'Ciática: sintomas, causas e tratamento fisioterapêutico'
description: 'O que caracteriza a dor ciática, suas causas mais comuns e como a fisioterapia atua no alívio e na prevenção de recidivas.'
pubDate: 'Mar 04 2026'
category: 'dor-e-coluna'
heroImage: '../../assets/physio-ciatica-hero.jpg'
heroImageAlt: 'Fisioterapeuta avaliando a região lombar e a perna de um paciente'
tags: ['coluna', 'ciática', 'dor lombar']
---

"Estou com ciática" é uma frase comum no consultório, mas nem sempre usada da forma correta. Ciática não é uma doença em si — é um conjunto de sintomas causado pela irritação do nervo ciático, o maior nervo do corpo, que percorre da região lombar até o pé.
...
Entre as causas mais frequentes de compressão do nervo ciático estão:

- **Hérnia de disco lombar**, quando o material herniado comprime a raiz nervosa.
- **Estenose do canal vertebral**, um estreitamento do espaço por onde passam as raízes nervosas, mais comum com o avanço da idade.
- **Síndrome do piriforme**, em que um músculo profundo do glúteo comprime o nervo em seu trajeto, sem relação direta com a coluna.

Identificar a causa exata é importante porque o tratamento pode variar bastante dependendo de onde está a origem do problema.

![Fisioterapeuta conduzindo alongamento de perna em paciente](../../assets/physio-ciatica-inline.jpg)

## Como a fisioterapia trata a ciática

O tratamento costuma seguir uma lógica progressiva:
