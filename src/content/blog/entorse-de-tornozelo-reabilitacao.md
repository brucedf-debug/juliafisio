...
heroImage: '../../assets/physio-tornozelo-entorse-hero.jpg'
heroImageAlt: 'Atleta com o tornozelo lesionado durante atividade física'
tags: ['fisioterapia esportiva', 'tornozelo', 'entorse']
---
...
![Fisioterapeuta bandagem no tornozelo de um atleta](../../assets/physio-tornozelo-entorse-inline.jpg)
...
## Exercícios comuns na fase de propriocepção

Essa etapa costuma ser a mais negligenciada em reabilitações feitas sem acompanhamento, mas é uma das mais importantes para evitar recidivas:

- **Equilíbrio em uma perna só**, primeiro em superfície firme e de olhos abertos, progredindo depois para superfícies instáveis, como um disco ou almofada de equilíbrio.
- **Exercícios com o olhar fechado**, que exigem mais do sistema de propriocepção, já que reduzem a referência visual.
- **Pequenos saltos controlados e aterrissagens**, reproduzindo de forma progressiva as exigências do esporte praticado.
- **Mudanças rápidas de direção**, na fase final, simulando situações reais de jogo ou corrida.
...
**Preciso fazer raio-x depois de toda entorse?** Nem sempre. Critérios clínicos específicos (como a incapacidade de apoiar o pé ou dor pontual sobre o osso) ajudam a decidir quando o exame é realmente necessário, evitando exposição desnecessária à radiação em casos mais simples.

**Gelo ou calor: qual usar logo depois da entorse?** Gelo é a recomendação para as primeiras 48 a 72 horas, já que ajuda a controlar o inchaço e a dor na fase inflamatória aguda. O calor só costuma entrar depois, quando o objetivo passa a ser relaxar a musculatura tensa ao redor da região já sem inchaço ativo.

**Posso caminhar normalmente logo após uma entorse leve?** Depende do grau da lesão. Em entorses bem leves, caminhar com cuidado costuma ser permitido rapidamente; em casos mais moderados, um período curto de apoio protegido ou uso de muletas pode ser necessário até a dor aguda ceder.

**Fita adesiva (bandagem) substitui a reabilitação?** Não. A bandagem oferece suporte externo temporário durante a fase de retorno, mas não desenvolve a força e a propriocepção que só o exercício terapêutico consegue reconstruir ao longo do tempo.

**Vale a pena continuar os exercícios de equilíbrio mesmo depois de recuperado?** Vale, e faz bastante diferença. Manter esses exercícios de forma esporádica na rotina, mesmo sem dor, é uma das formas mais eficazes de reduzir o risco de uma nova entorse no futuro.
