...
heroImage: '../../assets/physio-home-office-hero.jpg'
heroImageAlt: 'Pessoa trabalhando em um notebook em casa'
tags: ['coluna', 'postura', 'ergonomia']
---
...
![Mesa de trabalho organizada com notebook e apoio ergonômico](../../assets/physio-home-office-inline.jpg)
...
## Reuniões por vídeo e a tentação de ficar imóvel

Um padrão específico do home office que vale atenção é a tendência de ficar praticamente imóvel durante reuniões por vídeo, com receio de sair do enquadramento da câmera. Esse tipo de imobilidade prolongada, mantida várias vezes ao dia, soma-se à já reduzida variação de postura do trabalho remoto e intensifica a sobrecarga sobre a coluna. Pequenos ajustes ajudam: levantar a câmera em vez de olhar para baixo o tempo todo, posicionar o notebook de forma que permita algum movimento natural do tronco, e aproveitar reuniões apenas de áudio, quando possível, para caminhar ou alongar enquanto participa.
...
**Trabalhar da cama ou do sofá é sempre prejudicial?** Ocasionalmente não costuma ser um problema, mas como rotina principal de trabalho tende a favorecer posturas que sobrecarregam a coluna, já que essas superfícies não oferecem o suporte necessário para longos períodos de uso.

**Notebook é pior que desktop para a postura?** Pode ser, principalmente pela tendência de manter a tela mais baixa e mais próxima do corpo. Usar um suporte para elevar o notebook, junto de teclado e mouse externos, aproxima bastante a configuração de uma estação de trabalho mais ergonômica.

**Trabalhar em pé (mesa standing desk) resolve o problema?** Ajuda a variar a postura ao longo do dia, mas não deve ser mantida o tempo todo — o ideal é alternar entre sentado e em pé, já que ficar parado em qualquer posição por muito tempo sobrecarrega a coluna.

**Almofada lombar realmente funciona?** Sim, para muitas pessoas, principalmente em cadeiras sem apoio adequado na região baixa das costas, embora o efeito varie conforme o formato e a espessura da almofada escolhida para cada tipo de cadeira e cada corpo.
